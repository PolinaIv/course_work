...
%load('C:\Work\BCI\bci-master\EXP_DATA\EXP_LSL32_new\1305_lisa_re_first_2.mat');
    ...
    for sj=1:length(STATES)
        ...
        for Fc_high = 2:15
            ...
            for Bw = 3:8
                ...
                ResultTest = TestPair(data_cur, indTst1,indTst2,ResVsReg{indMax}, 200);
